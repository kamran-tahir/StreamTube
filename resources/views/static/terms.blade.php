        ...
        <div class="col-lg-12 col-md-12 col-sm-6 col-xs-6">
            ...
            <div class="box box-primary" style="margin-top: 10px">
                ...
                <div class="box-header with-border">
                    ...
                    <h2 class="pull-left">@if($data) {{$data->heading}} @else {{tr('registration_terms_conditions')}} @endif</h2>
                ...
                <div class="box-body">
                    ...
                    @if($data) <?php echo $data->description; ?> @else {{tr('registration_terms_conditions')}} @endif
