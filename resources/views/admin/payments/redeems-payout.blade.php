                ...
                <div class="col-xs-6">
                    ...
                    @if(in_array($data->redeem_request_status ,[REDEEM_REQUEST_SENT , REDEEM_REQUEST_PROCESSING]))
                        ...
                        <form action="https://www.sandbox.paypal.com/cgi-bin/webscr" method="post">
                            ...
                            <input name = "cancel_return" value = "{{route('admin.users.payout.response' , ['user_id' => $data->user_id , 'redeem_request_id' => $data->redeem_request_id , 'paid_amount' => 0, 'success' => false])}}" type = "hidden">
