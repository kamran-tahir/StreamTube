                    ...
                    <tbody>
                        ...
                        @foreach($channels as $i => $channel_details)
	                        ...
	                        <tr>
	                            ...
	                            <td>
	                                @if($channel_details->verificationStatus() === 1 )
	                                   <span class="label label-success">{{ tr('approved') }}</span> 
                                    @elseif($channel_details->verificationStatus() === 0 )
                                       <span class="label label-danger">{{ tr('decline') }}</span> 
                                    @elseif($channel_details->verificationStatus() === null )
	                                ...
	                                <ul class="admin-action btn btn-default">
	                                    ...
	                                    <li class="{{ $i <=2 ? 'dropdown' : 'dropup' }}">
	                                        ...
	                                        <ul class="dropdown-menu">
                                                ...
                                                <li role="presentation">
                                                    @if($channel_details->verificationStatus() === null || $channel_details->verificationStatus() === -1 )

                                                        <a role="menuitem" tabindex="-1" href="{{route('admin.channels.verification.request', ['channel_id' => $channel_details->id])}}">
                                               ...
                                               <!--  <li role="presentation">
                                                ...
                                                <li>
                                                    <a href="{{route('admin.channels.change_ad_status', ['channel_id' => $channel_details->id, 'enable_ad' => !$channel_details->ad_enabled])}}">
                                                        {{$channel_details->ad_enabled ? tr('disable_ad') : tr('enable_ad')}}
                                                    </a>
                                                </li>
	                                        </ul>
