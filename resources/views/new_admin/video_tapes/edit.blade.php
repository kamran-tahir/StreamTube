                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane active" role="tabpanel" id="pre-step1">
                        ...
                        <div id="category">
                            ...
                            <?php
                                $u_css = ($video_tape_details->video_type == VIDEO_TYPE_UPLOAD) ? 'category-item-active' : '';
                            ?>
                            ...
                            <?php
                                $y_css = ($video_tape_details->video_type == VIDEO_TYPE_YOUTUBE) ? 'category-item-active' : '';
                            ?>
                            ...
                            <?php
                                $o_css = ($video_tape_details->video_type == VIDEO_TYPE_OTHERS) ? 'category-item-active' : '';
                            ?>
                            ...
                            <input type="hidden" name="video_type" id="video_type" value="{{$video_tape_details->video_type}}" />
                    ...
                    <div class="tab-pane" role="tabpanel" id="step1">
                        ...
                        <hr>
                        <div class="">
                            <input type="hidden" name="id" id="main_id" value="{{$video_tape_details->video_tape_id}}">
                            <input type="hidden" name="is_banner" id="is_banner" value="{{$video_tape_details->is_banner}}">
                            ...
                            <input type="hidden" name="ratings" value="{{$video_tape_details->ratings}}" id="rating">

                            <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    <label for="ratings" class="">{{tr('ratings')}} *</label>
                                    <div class="starRating">
                                         <input id="rating5" type="radio" name="ratings" value="5" @if($video_tape_details->ratings == 5) checked @endif>
                                        <label for="rating5">5</label>

                                        <input id="rating4" type="radio" name="ratings" value="4" @if($video_tape_details->ratings == 4) checked @endif>
                                        <label for="rating4">4</label>

                                        <input id="rating3" type="radio" name="ratings" value="3" @if($video_tape_details->ratings == 3) checked @endif>
                                        <label for="rating3">3</label>

                                        <input id="rating2" type="radio" name="ratings" value="2" @if($video_tape_details->ratings == 2) checked @endif>
                                        <label for="rating2">2</label>

                                        <input id="rating1" type="radio" name="ratings" value="1" @if($video_tape_details->ratings == 1) checked @endif>
                            ...
                            <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12">
                                <div class="form-group">
                                   ...
                                   <!--  <input type="number" name="age_limit" placeholder="{{tr('age_limit')}}" class="form-control" id="age_limit" required maxlength="2" minlength="1" value="{{$video_tape_details->age_limit}}"> -->
                                   ...
                                   <input type="checkbox" name="age_limit" value="1" @if($video_tape_details->age_limit) checked @endif> {{tr('yes')}}
                            ...
                            <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <label>
                                        <input type="radio" name="video_publish_type" value="{{PUBLISH_NOW}}" class="flat-red" id="video_publish_type" onchange="checkPublishType(this.value)" @if($video_tape_details->video_publish_type == PUBLISH_NOW) checked @endif>
                                        {{tr('publish_now')}}
                                    </label>
                                    

                                    <label>
                                        <input type="radio" name="video_publish_type" class="flat-red"  value="{{PUBLISH_LATER}}" id="video_publish_type" onchange="checkPublishType(this.value)" @if($video_tape_details->video_publish_type == PUBLISH_LATER) checked @endif>
                                        {{tr('publish_later')}}
                                    </label>
                                          ...
                                          <div>
                                            ...
                                            <select id="category_id" name="category_id" class="form-control select2" required data-placeholder="{{tr('select_category')}}*" style="width: 100% !important">
                                                @foreach($categories as $category)
                                                      <option value="{{$category->category_id}}" @if($category->category_id ==  $video_tape_details->category_id) selected @endif>{{$category->category_name}}</option>
                                                    @endforeach
                                            </select>
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12" style="display: none;" id="duration_div">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="duration" class="form-control" data-inputmask="'alias': 'hh:mm:ss'" data-mask id="duration" value="{{$video_tape_details->duration}}">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <textarea  style="overflow:auto;resize:none" class="form-control" required rows="4" cols="50" id="reviews_textarea" name="reviews">{{$video_tape_details->reviews}}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <textarea  style="overflow:auto;resize:none" class="form-control" required rows="4" cols="50" id="description" name="description">{{$video_tape_details->description}}</textarea>
                                </div>
                            </div>
                    ...
                    <div class="tab-pane" role="tabpanel" id="step2">
                        ...
                        <div id="category">
                            ...
                            <?php
                                $css = ($channel->id == $video_tape_details->channel_id) ? 'category-item-active' : '';
                            ?>
                            <div class="col-lg-4 col-md-4 col-sm-12 col-sx-12">
                         ...
                         <div id="others_video_upload_section" style="display: none;">
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="url" required class="form-control" id="other_video" name="other_video" placeholder="{{tr('video')}}" value="{{$video_tape_details->video}}">
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                ...
                                <img src="{{$video_tape_details->default_image}}" style="width: 200px;height: 150px;">
...
@section('scripts')
    ...
    <script type="text/javascript">
        ...
        @if($video_tape_details->video_publish_type == "{{PUBLISH_LATER}}") 
        ...
        $.ajax({
         ...
         $("#"+"{{$video_tape_details->channel_id}}"+"_i").show();

         var main_video = "{{$video_tape_details->video}}";
         var edit_video_type = "{{$video_tape_details->video_type}}";
