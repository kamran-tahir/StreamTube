        ...
        <div class="col-md-12">
            ...
            <div class="box ">
                ...
                <div class="box-body">
                    ...
                    <strong><i class="fa fa-book margin-r-5"></i> Header</strong>
                    <p class="text-muted"><?= $page_details->heading?></p>
                    
                      @if(!empty($page_details->home_link))
                      <hr>
                    <strong><i class="fa fa-book margin-r-5"></i> Homepage URL</strong>
                    <p class="text-muted"><?= $page_details->home_link?></p>
                      <hr>

                    <strong><i class="fa fa-book margin-r-5"></i> Exit URL</strong>
                    <p class="text-muted"><?= $page_details->exit_link?></p>
                    @endif
                    <hr>
                    ...
                    <strong><i class="fa fa-book margin-r-5"></i> Background Image</strong>
                    <p class="text-muted">
                        <img style="width: 200px;height:200px;object-fit: cover;" src="<?= $page_details->bg_image?>" >
                        </p>
