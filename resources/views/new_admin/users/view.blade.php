	    ...
	    <div class="col-md-9">
	      	...
	      	<div class="nav-tabs-custom">
		        <ul class="nav nav-tabs">
					...
					<li class=""><a href="#spam_reports_list" data-toggle="tab" aria-expanded="false">Monetization History</a></li>
...
{{--						@if(count($users_referral_details) > 0 )--}}
							@if($users_referral_details != null )
