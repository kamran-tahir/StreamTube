    ...
    <div class="col-lg-11 col-md-11 col-sm-11 col-xs-11 streamview-tab-container">
        ...
        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 streamview-tab-menu">
            ...
            <div class="list-group">
                ...
                <a href="#" class="list-group-item text-left">{{ tr('registration_terms_conditions') }}</a>
                <a href="#" class="list-group-item text-left">{{ tr('verification_terms_conditions') }}</a>
                <a href="#" class="list-group-item text-left">{{ tr('channel_verification_terms_conditions') }}</a>
                <a href="#" class="list-group-item text-left">{{ tr('documents_upload_channel_verification_settings') }}</a>
                <a href="#" class="list-group-item text-left">{{ tr('video_terms_conditions') }}</a>
                <a href="#" class="list-group-item text-left">{{ tr('photo_terms_conditions') }}</a>
        ...
        <div class="col-lg-10 col-md-10 col-sm-9 col-xs-10 streamview-tab">
                ...
                <form action="{{ (Setting::get('admin_delete_control') == YES ) ? '#' : route('admin.settings.save') }}" method="POST" enctype="multipart/form-data" r  ole="form">
                    ...
                    <div class="box-body"> 
                        <div class="row"> 
                            ...
                            <div class="col-md-12">
                                <h3 class="settings-sub-header text-uppercase"><b>{{ tr('registration_terms_conditions') }}</b></h3>
                                <hr>
                            </div>

                            <div class="col-lg-12">
                                <div class="form-group">
                                    <label for="register_page_1">{{ tr('register_page_1') }}</label>
                                    <textarea class="form-control" id="register_page_1" name="register_page_1">{{ Setting::get('register_page_1') }}</textarea>
                                </div>
                            </div>  
                            <div class="col-lg-12">
                                <div class="form-group">
                                    <label for="register_page_2">{{ tr('register_page_2') }}</label>
                                    <textarea class="form-control" id="register_page_2" name="register_page_2">{{ Setting::get('register_page_2') }}</textarea>
                                </div>
                            </div>  
                            <div class="col-lg-12">
                                <div class="form-group">
                                    <label for="register_page_2">{{ tr('register_page_3') }}</label>
                                    <textarea class="form-control" id="register_page_3" name="register_page_3">{{ Setting::get('register_page_3') }}</textarea>
                                </div>
                            </div>
            ...
            {{-- Verification Terms and Condition --}}
            <div class="streamview-tab-content">
                <form action="{{ (Setting::get('admin_delete_control') == YES ) ? '#' : route('admin.settings.save') }}" method="POST" enctype="multipart/form-data" r  ole="form">
                    ...
                    <div class="box-body"> 
                        <div class="row"> 
                            ...
                            <div class="col-md-12">
                                <h3 class="settings-sub-header text-uppercase"><b>{{ tr('verification_terms_conditions') }}</b></h3>
                                <hr>
                            </div>

                            <div class="col-lg-12">
                                <div class="form-group">
                                    <label for="verification_page">{{ tr('verification_page_1') }}</label>
                                    <textarea class="form-control" id="verification_page_1" name="verification_page_1">{{ Setting::get('verification_page_1') }}</textarea>
                                </div>
                            </div>

                            <div class="col-lg-12">
                                <div class="form-group">
                                    <label for="verification_page_2">{{ tr('verification_page_2') }}</label>
                                    <textarea class="form-control" id="verification_page_2" name="verification_page_2">{{ Setting::get('verification_page_2') }}</textarea>
                                </div>
                            </div>

                            <div class="col-lg-12">
                                <div class="form-group">
                                    <label for="verification_page_3">{{ tr('verification_page_3') }}</label>
                                    <textarea class="form-control" id="verification_page_3" name="verification_page_3">{{ Setting::get('verification_page_3') }}</textarea>
                                </div>
                            </div>
            ...
            {{-- Channel Verification Terms and Condition --}}
            <div class="streamview-tab-content">
                    <div class="box-header"> 
                        <div class="row"> 

                            <div class="col-md-12">
                                <h3 class="settings-sub-header text-uppercase"><b>{{ tr('channel_verification_terms_conditions') }}</b>
                                </h3>
                            </div>
                            <div class="col-md-12">
                               <form class="form-inline text-right" action="{{route('admin.channel-settings.create')}}" method="post">
                                  {{ csrf_field() }}
                                  <div class="form-group mb-2">
                                  <label for="form-label" class="">Name: </label>
                                  </div>  
                                  <div class="form-group mb-2">
                                    <input type="text" class="form-control-plaintext"  value="" name="new_channel_verification_setting">
                                  </div>
                    ...
                    <div class="box-body" style="min-height: 100px;"> 
                        <div class="row">  
                            ...
                            <div class="col-lg-12">
                                <div class="form-group">
                                    <label for="verification_page"> {{ ucwords(str_replace('_' ,' ',$channel_verification_setting->key)) }}
                                    &nbsp; &nbsp; <a href="javascript:;" class="" onclick="confirmDelete({{ $channel_verification_setting->id }})" ><i class="fa fa-lg fa-trash text-danger "></i></a></label>
                                    <textarea class="form-control" id="{{$channel_verification_setting->key}}" name="{{$channel_verification_setting->key}}">{{$channel_verification_setting->value }}</textarea>
                                </div>
                            </div>
                            @endforeach
                            @if(count($channel_verification_settings) == 0)
                            <div class="col-lg-12 text-center">
                                <h4>No verification setting exists</h4>
                            </div>
                            @endif
            ...
            {{-- Channel Verification Documents Upload Settings --}}
            <div class="streamview-tab-content">
                <form action="{{ (Setting::get('admin_delete_control') == YES ) ? '#' : route('admin.settings.save') }}" method="POST" enctype="multipart/form-data" r ole="form">
                    ...
                    <div class="box-body"> 
                        <div class="row"> 
                            ...
                            <div class="col-md-12">
                                <h3 class="settings-sub-header text-uppercase"><b>{{ tr('documents_upload_channel_verification_settings') }}</b></h3>
                                <hr>
                            </div>

                            <div class="col-lg-10">
                                <div class="form-group">
                                    <label for="documentupload_channel_verification_setting_1">{{ tr('documentupload_channel_verification_setting_1') }} </label> 
                                    <textarea class="form-control" id="documentupload_channel_verification_setting_1" name="documentupload_channel_verification_setting_1">{{ Setting::get('documentupload_channel_verification_setting_1') }}</textarea>
                                </div>
                            </div>

                            <div class="col-lg-2">
                                <div class="form-group">
                                    <label for="documentupload_channel_verification_setting_1_status"> Active </label> 
                                    <div class="form-check">
                                    <input class="form-check-input documentupload_channel_verification_setting_status" data-input-id="documentupload_channel_verification_setting_1_status" type="checkbox" value="1"  @if(Setting::get('documentupload_channel_verification_setting_1_status')) checked @endif />
                                    
                                    <input type="hidden" id="documentupload_channel_verification_setting_1_status" name="documentupload_channel_verification_setting_1_status" value="{{Setting::get('documentupload_channel_verification_setting_1_status')}}">
                                    </div>
                                </div>
                            </div> 
                            ...
                            <div class="col-lg-10">
                                <div class="form-group">
                                    <label for="documentupload_channel_verification_setting_2">{{ tr('documentupload_channel_verification_setting_2') }}</label>
                                    <textarea class="form-control" id="documentupload_channel_verification_setting_2" name="documentupload_channel_verification_setting_2">{{ Setting::get('documentupload_channel_verification_setting_2') }}</textarea>
                                </div>
                            </div> 

                            <div class="col-lg-2">
                                <div class="form-group">
                                    <label for="documentupload_channel_verification_setting_2_status"> Active </label> 
                                    <div class="form-check">
                                    <input class="form-check-input documentupload_channel_verification_setting_status" data-input-id="documentupload_channel_verification_setting_2_status" type="checkbox"  value="1" @if(Setting::get('documentupload_channel_verification_setting_2_status')) checked @endif />

                                    <input type="hidden" id="documentupload_channel_verification_setting_2_status" name="documentupload_channel_verification_setting_2_status" value="{{Setting::get('documentupload_channel_verification_setting_2_status')}}">
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-10">
                                <div class="form-group">
                                    <label for="documentupload_channel_verification_setting_3">{{ tr('documentupload_channel_verification_setting_3') }}</label>
                                    <textarea class="form-control" id="documentupload_channel_verification_setting_3" name="documentupload_channel_verification_setting_3">{{ Setting::get('documentupload_channel_verification_setting_3') }}</textarea>
                                </div>
                            </div>
                            <div class="col-lg-2">
                                <div class="form-group">
                                    <label for="documentupload_channel_verification_setting_3_status"> Active </label> 
                                    <div class="form-check">
                                    <input class="form-check-input documentupload_channel_verification_setting_status" data-input-id="documentupload_channel_verification_setting_3_status" type="checkbox" value="1" @if(Setting::get('documentupload_channel_verification_setting_3_status')) checked @endif />

                                    <input type="hidden" id="documentupload_channel_verification_setting_3_status" name="documentupload_channel_verification_setting_3_status" value="{{Setting::get('documentupload_channel_verification_setting_3_status')}}">
                                    </div>
                                </div>
                            </div> 
                    ...
                    <div class="box-body"> 
                        <div class="row"> 
                            ...
                            <div class="col-md-12">
                                ...
                                <h3 class="settings-sub-header text-uppercase"><b>{{ tr('video_terms_conditions') }}</b></h3>
                            ...
                            <div class="col-lg-12">
                                <div class="form-group">
                                    <label for="video_upload_checkbox_1">{{ tr('video_upload_checkbox_1') }}</label>
                                    <textarea class="form-control" id="video_upload_checkbox_1" name="video_upload_checkbox_1">{{ Setting::get('video_upload_checkbox_1') }}</textarea>
                                </div>
                            </div> 

                            <div class="col-lg-12">
                                <div class="form-group">
                                    <label for="video_upload_checkbox_2">{{ tr('video_upload_checkbox_2') }}</label>
                                    <textarea class="form-control" id="video_upload_checkbox_2" name="video_upload_checkbox_2">{{ Setting::get('video_upload_checkbox_2') }}</textarea>
                                </div>
                            </div> 

                            <div class="col-lg-12">
                                <div class="form-group">
                                    <label for="video_upload_checkbox_3">{{ tr('video_upload_checkbox_3') }}</label>
                                    <textarea class="form-control" id="video_upload_checkbox_3" name="video_upload_checkbox_3">{{ Setting::get('video_upload_checkbox_3') }}</textarea>
                                </div>
                            </div> 
                    ...
                    <div class="box-body"> 
                        <div class="row"> 
                            ...
                            <div class="col-md-12">
                                ...
                                <h3 class="settings-sub-header text-uppercase"><b>{{ tr('photo_terms_conditions') }}</b></h3>
                            ...
                            <div class="col-lg-12">
                                <div class="form-group">
                                    <label for="photo_upload_checkbox_1">{{ tr('photo_upload_checkbox_1') }} </label>
                                    <textarea class="form-control" id="photo_upload_checkbox_1" name="photo_upload_checkbox_1">{{ Setting::get('photo_upload_checkbox_1') }}</textarea>
                                </div>
                            </div> 

                            <div class="col-lg-12">
                                <div class="form-group">
                                    <label for="photo_upload_checkbox_2">{{ tr('photo_upload_checkbox_2') }}</label>
                                    <textarea class="form-control" id="photo_upload_checkbox_2" name="photo_upload_checkbox_2">{{ Setting::get('photo_upload_checkbox_2') }}</textarea>
                                </div>
                            </div> 

                            <div class="col-lg-12">
                                <div class="form-group">
                                    <label for="photo_upload_checkbox_3">{{ tr('photo_upload_checkbox_3') }}</label>
                                    <textarea class="form-control" id="photo_upload_checkbox_3" name="photo_upload_checkbox_3">{{ Setting::get('photo_upload_checkbox_3') }}</textarea>
                                </div>
                            </div> 
...
<form action="" method="POST" id="delete_channel_verification_setting">
...
<script>
    ...
    $('.documentupload_channel_verification_setting_status').on('change', function(){
...
<script type="text/javascript">
    ...
    function confirmDelete(id){
        let url = "{{ route('admin.channel-settings.delete', ['id' => ':id']) }}";
        url = url.replace(':id', id);
        $.alert({
            icon:'fa fa-trash',
            theme: 'bootstrap',
            title: 'Are you sure',
            content: 'You want to DELETE this channel verification setting',
            buttons: {
                cancel:{
                    action: function(){
                ...
                continue:{
                    btnClass: 'btn-blue',
                    action: function(){
                        $('#delete_channel_verification_setting').attr('action',url);
                        $('#delete_channel_verification_setting').submit();
                    }
                }
            }
        });
