            ...
            <div class="page-inner col-sm-9 col-md-10">
                ...
                <div class="spacing1 top">
                    <div class="pull-right">
                        ...
                        <a href="{{route('user.subscriptions')}}"><button class="btn btn-sm btn-danger mb-20">Cancel Membership</button></a>

                    </div>

                    <h2 class="no-margin" style="color: #0f7b9f ;">Membership History</h2>
