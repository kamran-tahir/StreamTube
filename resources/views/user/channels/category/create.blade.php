            ...
            <div class="profile-content slide-area1">
                ...
                <div class="row no-margin">
                    ...
                    <div class="col-sm-12 col-md-10 col-lg-9 profile-view">
                        ...
                        <h3 class="mylist-head">Create Category</h3>
                        ...
                        <div class="edit-profile profile-view">
                            ...
                            <div class="edit-form profile-bg">
                                ...
                                <div class="editform-content"> 
                                    ...
                                    <form  action="{{route('user.channel.member-section.category.store',$channel)}}" method="POST" enctype="multipart/form-data">
                                        {!! csrf_field() !!}
                                        <div class="form-group">
                                            <label for="title">Name</label>
                                            <input type="text" value="{{old('name') }}" name="name" class="form-control" placeholder="Title" id="title" >
                                        </div>
