...
<div class="login-space">
        <div class="common-form login-common">
            ...
            <div class="sign-up">
                ...
                <form  action="{{ route('ad.save') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                     ...
                     <div class="form-group">
                        ...
                        <input type="text" required name="email"  class="form-control" id="address1" placeholder="Address" value="">
                    </div>
                     <div class="form-group">
                        <label for="address1">Phone Number*</label>
                        <input type="text" required name="phone"  class="form-control" id="address1" placeholder="Address" value="">
                    </div>
                     <div class="form-group">
                        <label for="address1">Address*</label>
                        <input type="text" required name="address"  class="form-control" id="address1" placeholder="Address" value="">
                    </div>
                    <div class="form-group">
                        <label for="first name">Ad Type*</label>
                        <select class="form-control" name="ad_type" required onchange="yesnoCheck(this)">
                    ...
                    <div class="form-group" id="ad_skip_time">
                        <label for="last name">Ad Time To Skip*</label>
                        <input type="text"  name="ad_skip_time" min="15" class="form-control" id="" placeholder="Ad Time" value="">
                    </div>
                    <div class="form-group">
                        <label for="last name">Ad Duration*</label>
                        <input type="text" required name="ad_duration" min="15" class="form-control" id="" placeholder="Ad Duration" value="">
                    </div>
                    <div class="form-group">
                        <label for="dob">URL*</label>
                        <input type="text" name="url" class="form-control" placeholder="URL" id="" required  value="">
                    </div>
                    <!-- <div class="form-group">
   ...
   success: function(response)
                {
                    ...
                    <div class="form-group">
                        <label for="driving license">Vedio,Image*</label>
                        <br>
                        <br>
                       <!--  <img src="{{asset('document.png')}}" id="file" style="height: 100px;width: 100px;object-fit: contain;"> -->
                        <input type="file" required name="file" class="form-control" id="file" accept="image/png, image/jpeg" placeholder="" title="" value="" onchange="loadFile(this,'file')">
                    </div>
                   <!--  <div class="form-group">
                    ...
                    <div class="change-pwd">
                        <button type="submit" class="btn btn-primary signup-submit" id="btn_submitt">{{tr('submit')}}</button>
                    </div>  
...
<script>
      function yesnoCheck(that) {
        if (that.value == "banner" || that.value == "home_page" || that.value == "video_page") {
            document.getElementById("ad_skip_time").style.display = "none";
        } else {
            document.getElementById("ad_skip_time").style.display = "block";
        }
      }
</script>      
