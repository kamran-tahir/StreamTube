        ...
        <div class="col-sm-12">
            ...
            <div class="wizard-container">
                ...
                <div class="card wizard-card" data-color="red" id="wizard">
                    ...
                    <form action="{{Setting::get('admin_delete_control') ? '' : route('user.save_photos')}}" method="post" id="video_form" enctype="multipart/form-data">
                        ...
                        <div class="wizard-header">
                            ...
                            <h5>{{tr('photo_short_notes' , Setting::get('site_name'))}}</h5>
                        </div>

                        <div class="wizard-navigation">
                            <ul>
                                <li id="1">
                                    <a href="#video_type_upload" data-toggle="tab" class="dis-all">{{tr('photo_type')}}</a>
                                    <a href="#video_type_upload" data-toggle="tab" class="dis-mob">type</a>
                                </li>
                                <li id="2">
                                    <a href="#details" data-toggle="tab">{{tr('photo_details')}}</a>
                                </li>
                                <li id="3">
                                    <a href="#captain" data-toggle="tab">{{tr('upload_photo')}}</a>
                                </li>
                                <!-- <li id="4">
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane" id="details">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        ...
                                        <div>
                                            <input type="text" required class="form-control" id="title" name="title" placeholder="{{tr('photo_title')}}" value="{{old('title')}}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                        <div class="form-group">
                                            ...
                                            <p class="help-block">{{tr('age_limit_note_photo')}}</p>
                                        </div>
                                    </div>
                                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                        <div class="form-group">
                                            <label for="datepicker" class="">Promote this photo  </label>
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                        <div class="form-group">
                                            <label for="name" class="control-label">Members Only</label>&nbsp;&nbsp;
                                            <div class="clearfix"></div>
                                            <div>
                                                <input type="radio" name="members_only" value="1"  class='video_publish_type_class' required> {{tr('yes')}} &nbsp;
                                                <input type="radio" name="members_only" value="0" checked class="video_publish_type_class" required /> {{tr('no')}}
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-data">
                                        ...
                                        <div class="col-lg-4 col-md-6 col-sm-12 col-xs-12">
                                            ...
                                            <label for="video" class="control-label">{{tr('channel')}} * </label>
                                            <div>

                                                <select id="channel_id" name="channel_id" class="form-control select2" required data-placeholder="{{tr('select_channel')}}*" style="width: 100% !important">
                            ...
                            <div class="tab-pane" id="captain">
                                <h4 class="info-text">{{tr('do_upload_photo')}}</h4>
                                ...
                                <div class="row" id="others_video_upload_section" style="display: none;">
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <label for="other_video" class="">{{tr('photo')}} * </label>

                                            <input type="url" class="form-control" id="other_video" name="other_video" placeholder="{{tr('photo')}}">
                                ...
                                <div class="" id="file_video_upload_section">
                                    ...
                                    @else
                                        <input id="video_file" type="file" name="video" style="display: none;" accept="image/*" onchange="$('#submit_btn').click();" required> 
                                    @endif
                                ...
                                <div class="" style="padding-bottom: 5px">
                                    <div class="col-lg-12 form-group">
                                        <label for="photo_upload_checkbox_1" style="margin-left: 24px; margin-top: 13px;"> {{ Setting::get('photo_upload_checkbox_1') }}</label>
                                        <input type="checkbox" required name="photo_upload_checkbox_1"  class="form-control terms-checkbox" id="photo_upload_checkbox_1"
                                ...
                                <div class="" style="padding-bottom: 5px">
                                    <div class="col-lg-12 form-group">
                                        <label for="photo_upload_checkbox_2" style="margin-left: 24px; margin-top: 13px;"> {{ Setting::get('photo_upload_checkbox_2') }}</label>
                                        <input type="checkbox" required name="photo_upload_checkbox_2"  class="form-control terms-checkbox" id="photo_upload_checkbox_2"
                                            onchange="updateNextButtonState()" 
                                            style="width: 15px; position: absolute;">
                                    </div>
                                </div>
                                <div class="" style="padding-bottom: 5px">
                                    <div class="col-lg-12 form-group">
                                        <label for="photo_upload_checkbox_3" style="margin-left: 24px; margin-top: 13px;"> {{ Setting::get('photo_upload_checkbox_3') }}</label>
                                        <input type="checkbox" required name="photo_upload_checkbox_3"  class="form-control terms-checkbox" id="photo_upload_checkbox_3"
                                            onchange="updateNextButtonState()" 
                                            style="width: 15px; position: absolute;">
                                    </div>
                                </div>
                                ...
                                <div class="">
                                    ...
                                    <div class="pull-right">
                                        ...
                                        <button type='submit' class='btn btn-fill btn-danger btn-wd finish' name='finish' value='Finish' id="manual_finish" style="display: none;">
                                        <a href="{{route('user.view.photos')}}">
                            ...
                            <div class="tab-pane" id="select_image">
                                <div class="row">
                                    <h4 class="info-text">{{tr('select_photo_short_notes')}}</h4>
      ...
      $.ajax({
          ...
          success : function(data) {
              if (data.success)  {
                  ...
                  window.location.href = baseURL+'/channel/'+$("#channel_id").val()+"#videos";
              } else {
...
<script>
    function updateNextButtonState(){
        ...
        document.getElementById('manual_finish').disabled = (notChecked != 0)
    }
</script>
