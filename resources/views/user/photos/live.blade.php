                        ...
                        <div class="card wizard-card" data-color="red" id="wizard">
                            ...
                            <form action="{{Setting::get('admin_delete_control') ? '' : route('user.video_save')}}" method="post" id="video_form" enctype="multipart/form-data">
                                ...
                                <div class="wizard-header">
                                    ...
                                    <h5>By submitting your photos to DODUCKY, you acknowledge that you agree to DODUCKY Terms of Service and Privacy Policy </h5>
                                ...
                                <div class="wizard-navigation">
                                    ...
                                    <ul>
                                        ...
                                        <li id="1">
                                            ...
                                            <a href="#video_type_upload" data-toggle="tab" class="dis-all">Photo Type</a>
                                        ...
                                        <li id="2">
                                            ...
                                            <a href="#details" data-toggle="tab">Photo Details and Tags</a>

                                        </li>

                                        <li id="3">

                                            <a href="#captain" data-toggle="tab">Upload</a>
                                    ...
                                    <div class="tab-pane" id="video_type_upload">
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-12 col-sx-12">
                                            ...
                                            <a onclick="saveVideoType({{VIDEO_TYPE_YOUTUBE}}, {{REQUEST_STEP_PRE_1}})" class="category-item text-center">
                                                ...
                                                <h3 class="category-tit">Photo Link</h3>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-12">
                                                ...
                                                <div>
                                                    ...
                                                    <input type="text" required class="form-control" id="title" name="title" placeholder="Photo Title" value="{{old('title')}}">
...
{{--                                                </div>--}}
                                            ...
                                            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <p class="help-block">Above this age users can view the photo</p>
                                    ...
                                    <div class="tab-pane" id="captain">
                                        ...
                                        <h4 class="info-text">Click on Start to Go Live</h4>
                                        ...
                                        <div class="booth col-md-12">

                                            <video id="video" width="75%" height="50%" autoplay></video>

                                            <canvas id="canvas" width="75%" height="50%"></canvas>
