...
<!-- /////////////////////////////////// -->
<script src="{{asset('streamtube/js/jssor.slider-28.1.0.min.js')}}" type="text/javascript"></script>
 ...
 <div class="row content-row">
    ...
    <div class="page-inner">
        ...
        <div>
          ...
          <img data-u="image" src="{{$user_photo->path}}" />
          <img data-u="thumb" src="{{$user_photo->path}}" style="width: 190px;height: 90px;object-fit: cover;" />
             ...
             <!-- @foreach($photo as $user_photo)
                <div class="slide-box recom-box">
                    <div class="slide-image">
                     ...
                     @else
                     <img src="{{asset('placeholder.png')}}" class="slide-img1 placeholder" />
                     @endif
                    </div>
                </div>      
             @endforeach -->
