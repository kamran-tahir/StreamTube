<aside class="main-sidebar">
    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu">
           ...
           <!--  <li id="verification">
                <a href="{{route('admin.users.document')}}">
                    <i class="fa fa-certificate"></i> <span>Verification Applications</span>
                </a>
            ...
            <li class="treeview" id="channels">
                ...
                <ul class="treeview-menu">
                    ...
                    <li id="channels-verifications"><a href="{{route('admin.channels.verification.request.list')}}"><i class="fa fa-circle-o"></i>Verification Requests</a></li>
            ...
            <li class="treeview" id="videos-ads-details">
                ...
                <ul class="treeview-menu">
                    ...
                    <li>
                        <a href="{{route('admin.ad-request.index')}}"><i class="fa fa-circle-o"></i>Ad Requests</a>
                    </li>
                </ul>
