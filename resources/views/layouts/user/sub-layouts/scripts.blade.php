...
<script type="text/javascript">
    ...
    $('a.confirm-redirection').confirm({
        theme: 'bootstrap',
        title: 'Do you want to leave?',
        content: 'The claims and opinions expressed are solely those of the advertiser and do not represent the views or options of the site or this channel. Nor does the content that follows necessarily represent the views or opinions of  the advertiser and placement of thus ad does not indicate it does. ',
        buttons: {
            cancel:{
                action: function(){
