                ...
                <table style="max-width:100%; min-width:100%;" class="mcnTextContentContainer" width="100%" cellspacing="0" cellpadding="0" border="0" align="left">
                    <tbody><tr>
                        ...
                        <td class="mcnTextContent" style="padding: 0px 18px 9px;color: #000000;font-style: normal;font-weight: normal;" valign="top">
                           ...
                           Your received this message because you registered to our website. Welcome to our community.

                           <br>

                           <br>

                            <div><b>Your Login Credentials are below:</b></div>

                             <p><b>Email&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:</b> {{$email_data['email']}}</p>

                             <p><b>Password :</b> {{$email_data['password']}}</p>
