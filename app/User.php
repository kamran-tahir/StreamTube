...
class User extends Authenticatable
{
     ...
     * @var array
     */
    protected $fillable = ['name', 'email', 'password','user_type','device_type','login_by',
        'picture','is_activated', 'timezone', 'verification_code' , 
        'verification_code_expiry','is_verified','age_limit', 'dob','address','idcard_doc','residence_doc','first_name','last_name','tpi_ssn','address1','address2','state','zip_code','country','driving_lisence_doc','login_count'
    ];
    ...
    public function userSearchHistory() {
        return $this->hasMany('App\UserSearchHistory')->orderBy('updated_at' , 'asc');
    }
    /**
     * Save the unique ID 
     *
    ...
    public function member_of() {
        return $this->belongsToMany('App\Channel','channels_members','user_id');
    }
    ...
    public function like_posts() {
        return $this->hasMany('App\PostReaction','user_id')->where('like',1);
    }

     /**
     * dislike posts.
     */
    public function dislike_posts() {
        return $this->hasMany('App\PostReaction','user_id')->where('like',0);
    }
    
    /**
     * channel posts.
     */
    public function channel_posts() {
        return $this->hasMany('App\ChannelPost','user_id');
    }
