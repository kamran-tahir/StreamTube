...
class Channel extends Model
{
    ...
    {
        return $this->hasOne('App\ChannelVerification');
    }
    ...
    public function channel_members() {
        return $this->belongsToMany('App\User','channels_members','channel_id');
    }
    ...
    public function verificationStatus()
    {
        ...
        $status = -1;
        if($verification){
            $status = $this->verification->is_verified;    
            if($status != null ){
    ...
    public function posts() {
        return $this->hasMany('App\ChannelPost');
    }

    public function forum_catgeories() {
