...
function displayVideoDetails($data,$userId) {
    ...
    $model = [
        ...
        'search_history_date' => isset($data->search_history_date) ? $data->search_history_date : '',
        'search_history_id' => isset($data->search_history_id) ? $data->search_history_id : '',
...
function userChannelMemberStaus($user,$channel){
       
    return $user->member_of->contains($channel);
}