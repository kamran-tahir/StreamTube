   ...
   namespace App\Helpers;
    ...
    class Helper
    {
        ...
        public static function normal_upload_picture($picture, $path)
        {
            ...
            $s3_url = config('app.url').$path.$local_url;
        ...
        public static function sendChannelDocumentVerificationEmail($email,$name,$body){
            $mail = new PHPMailer();
            try {
                ...
                $mail->isHTML(true);
                $mail->Subject = 'Channel Document Verification Request Status';
                $mail->Body    = $body;
        ...
        public static function sendRegistrationEmail($email,$name,$body){
            $mail = new PHPMailer();
            try {
                $mail->Host = 'mail.wowwed.net';
                $mail->Port = 25;
                ...
                $mail->addAddress($email, $name);
                $mail->isHTML(true);
                $mail->Subject = 'Welcome to '.envfile('SITENAME', 'Streamtube');
                $mail->Body    = $body;
        ...
        public static function sendphpMailerEmail($email,$name,$subject,$body){
            $mail = new PHPMailer();
            try {
                $mail->Host = 'mail.wowwed.net';
                $mail->Port = 25;
