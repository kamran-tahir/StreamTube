       ...
       $regex = '/^(https?:\/\/)?([\da-z\.-]+)\.([a-z\.]{2,6})([\/\w \.-]*)*\/?$/';
        try {
            ...
            $validator = Validator::make( $request->all(),array(
                    ...
                    'ad_type' => 'required',
                    'file' => 'required|mimes:jpeg,jpg,png,gif,mp4,webm,3gp',
                    'ad_url'=>'required|active_url'
                    //'ad_url'=>'required|regex:'.$regex
                    // 'ad_url'=>'required|max:255'
                ),array('ad_url.active_url' => 'The ad url is not a valid URL. e.g (Https://www.google.com)')
            );
            ...
            if($validator->fails()) {
                ...
                $ads_detail_details->status = (in_array($request->get('ad_type'), ['HOME_AD', 'VIDEO_PAGE AD','SEARCH_PAGE_AD'])) ? DEFAULT_FALSE : DEFAULT_TRUE;
                ...
                $ads_detail_details->ad_type = $request->ad_type;
