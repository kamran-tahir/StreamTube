        ...
        try {  
            ...
            if ($validator->fails()) {
                ...
                if ($request->channel_id != '') {
                    ...
                    $channel_details->is_approved = DEFAULT_FALSE;
    ...
    public static function video_save($request) {
        ...
        try {
            ...
            if( $validator->fails() ) {
                ...
                //////////////////////////////
                $model->member_only = $request->has('member_only') ? $request->member_only : $request->member_only;
                /////////////////////////////
    ...
    public static function upload_video_image($request) {
        ...
        try {
            ...
            if ($video) {
                ...
                //////////////////////////////
                $video->member_only = $request->has('member_only') ? $request->member_only : $request->member_only;
                /////////////////////////////
