...
Route::get('ad/submit', 'UserController@ad_submit')->name('ad.submit');

Route::post('ad/save', 'UserController@ad_submit_save')->name('ad.save');

Route::get('photos/gallery/{channel_id?}', 'UserController@photos_gallery')->name('user.photos.gallery');
Route::get('view/photos', 'UserController@view_photos')->name('user.view.photos');
Route::get('document/residence', 'NewAdminController@document_residence')->name('document.residence');
Route::get('document/view', 'NewAdminController@document_idcard')->name('document.view');

Route::post('document/save', 'UserController@document_save')->name('document.save');

Route::get('country/state', 'UserController@get_state')->name('country.state');
Route::get('state/city', 'UserController@get_city')->name('state.city');

Route::get('document/verification', 'UserController@document_verification')->name('ducoment.verify');
...
Route::group(['prefix' => 'admin', 'as' => 'admin.'], function () {
    ...
    Route::get('/testEmail', 'NewAdminController@testEmail')->name('testEmail');


    // New Admin user methods
    Route::get('/document/verification', 'NewAdminController@document_verification')->name('users.document');

    Route::get('/users/verification-application', 'NewAdminController@verification_application')->name('verification');
    ...
    Route::get('/channels/verification/request/list', 'ChannelVerificationController@verificationRequestListAdmin')->name('channels.verification.request.list')->middleware('admin');

    Route::get('/channels/verification/request', 'ChannelVerificationController@verificationRequestAdmin')->name('channels.verification.request')->middleware('admin');

    Route::post('/channels/verification/request', 'ChannelVerificationController@verificationRequestUpdateAdmin')->name('channels.verification.request.update')->middleware('admin');
    ...
    Route::get('/channels/change-ad-status', 'NewAdminController@changeAdStatus')->name('channels.change_ad_status');
    ...
    Route::get('ad-request/index', 'NewAdminController@ad_request_index')->name('ad-request.index');
    ...
    Route::get('ads-details/top_status', 'NewAdminController@ads_details_top_status')->name('ads-details.top_status');
    // New Admin coupons methods ends
    ...
    Route::get('revenues/plus/ab', 'NewAdminController@plusab')->name('revenues.plusab'); //ab1
    ...
    Route::post('tax-settings_save', 'NewAdminController@tax_settings_save')->name('tax-settings.save');

    Route::post('channel_setting_create', 'NewAdminController@addNewChannelSetting')->name('channel-settings.create');

    Route::Delete('channel_setting_delete/{id}', 'NewAdminController@deleteChannelSetting')->name('channel-settings.delete');
    ...
    Route::get('videos/remove-ad', 'NewAdminController@removeAdsFromVideo')->name('videos.remove_ad');
...
Route::group(['as' => 'user.', 'middleware' => 'ShowSecurityPage'], function () {
    ...
    Route::get('channel/{channel}/verification/form', 'ChannelVerificationController@channel_verification_form')->name('channel.verification.form')->middleware(['auth']);

    Route::post('channel/{channel}/verification', 'ChannelVerificationController@channel_verification')->name('channel.verification')->middleware(['auth']);

    Route::post('channel/{channel}/verification/update', 'ChannelVerificationController@channel_verification_update')->name('channel.verification.update')->middleware(['auth']);


    Route::get('video/{id}', 'UserController@video_view')->name('single');

    Route::get('download-video/{id}', 'UserController@downloadVideo')->name('download_video');
    ...
    Route::post('addReply', 'UserController@add_reply')->name('add.reply');
    ...
    Route::post('update/search-history-status', 'UserController@search_history_status')->name('search-history.status.update');

    Route::post('clear/search-history', 'UserController@clear_search_history')->name('search-history.clear');
    ...
    Route::get('video-live', 'UserController@video_live')->name('live'); //new_route

    Route::get('photo-live', 'UserController@photo_live')->name('photo'); //new_route
    Route::get('memberships', 'UserController@memberships')->name('memberships'); //new_route
    Route::get('dmca', 'UserController@dmca')->name('dmca'); //new_route
    Route::get('abusive', 'UserController@abusive')->name('abusive'); //new_route

    Route::get('verification-form', 'UserController@verification')->name('verification'); //new_route
    ...
    Route::post('save_photos', 'UserController@save_photos')->name('save_photos');
    ...
    Route::post('change-download-status', 'UserController@changeDownloadStatus')->name('change_downloadable_status');
    ...
    Route::post('/partialPhotos', 'UserController@partialPhotos')->name('photo.get_photos');
    ...
    require(__DIR__ . '/Routes/channel_member_section.php');
});
